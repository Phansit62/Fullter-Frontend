...
class _AddFoodState extends State<AddFood> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    onSaved: (newValue) => food.price = int.parse(newValue!),
                    validator: (String? value) {
                      return (value!.isEmpty) ? 'กรุณากรอกข้อมูล' : null;
                    },
                  ),
  ...
  // Widget _dropdownCategory(List<CategoryFoods> data) {
  //   return Container(
  //     margin: EdgeInsets.only(left: 16, right: 16),
  ...
  //         ),
  //       ),
  //       value: food.catefoodId,
  //       items: data.map((value) {
  //         return DropdownMenuItem(
  //           value: value.categoryFoodId,
  //           child: Text(value.typeFood.toString()),
  //         );
  //       }).toList().cast<DropdownMenuItem<int>>(),
  //       onChanged: (value) {
  //         setState(() {
  //           food.catefoodId = value! as int;
  //         });
  //       },
  //     ),
  //   );
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      onTap: () {
                        setState(() {
                          food.catefoodId = data[index].categoryFoodId as int;
                          _selectedCategory = data[index].typeFood.toString();
                        });
                        print(food.catefoodId);
                        Navigator.pop(context);
                      },
                    );
                  },
